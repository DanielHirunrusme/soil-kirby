...
var settings=require("modules/settings");module.exports=function(t){function i(){console.log("%c [video init]","color:blue");var t="";return r.find("source").each(function(){$(this).attr("data-src").indexOf("hd.mp4")>=0&&(t=$(this).attr("data-src"))}),r.find("video").attr("src",t),!0}var r=$(t);$(window),$(".block").length-1,r.attr("id");i()};
