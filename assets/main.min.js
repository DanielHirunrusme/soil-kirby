...
var settings=require("modules/settings"),slideshow=require("modules/slideshow");module.exports=function(o){function e(){console.log("%c [video init]","color:blue");var o="";n.find("source").each(function(){$(this).attr("src").indexOf("hd.mp4")>=0&&(o=$(this).attr("src"))});var e=s.find("source").attr("src");n.find("video").attr("src",o);var r={};r.muted=!0,r.autoplay=!0,r.controls=!1,r.hls={withCredentials:!0},$(".video-positioner").on("click",function(){console.log("mousedown")}),$(".play-button").on("click mouseup touchdown",function(o){o.stopPropagation(),console.log("play mobile video"),d.play(),d.requestFullscreen()}),console.log("src "+e),console.log("vidID "+i);var d=window.player=videojs(i,r);return d.on("ready",function(){console.log("player ready"),d.play(),t=!0}),d.on("pause",function(){$("body").hasClass("slideshow")||d.play()}),d.on("timeupdate",function(){var o=d.currentTime();d.duration();0==o&&(l||(l=!0,d.trigger("ended")))}),d.on("ended",function(){l&&(console.log("player ended 1"),$("body").hasClass("slideshow")&&n.closest(".video-block").hasClass("active")&&slideshow.nextBlock(),setTimeout(function(){l=!1},1e3))}),!0;var d}var n=$(o),s=($(window),$(".block").length-1,n.find("video")),i=s.attr("id"),t=!1,l=!1;e()};
