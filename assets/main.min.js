...
var settings=require("modules/settings");module.exports=function(o){function t(){console.log("%c [video init]","color:blue");var o="";i.find("source").each(function(){$(this).attr("data-src").indexOf("hd.mp4")>=0&&(o=$(this).attr("data-src"))}),i.find("video").attr("src",o);var t={};videojs.options.autoplay=!0,t.controls=!0,$(".play-button").on("click",function(){console.log("play mobile video"),e.play(),e.requestFullscreen()});var e=videojs(s,t,function(){videojs.log("Your player is ready!");this.options.poster=i.data("poster"),!settings.isMobile;var o="";i.find("source").each(function(){$(this).attr("data-src").indexOf("hd.mp4")>=0&&(o=$(this).attr("data-src"))}),console.log(o),i.find("video").attr("src",o),this.play(),this.on("ended",function(){videojs.log("Awww...over so soon?!")})})}var i=$(o),s=($(window),$(".block").length-1,i.attr("id"));t()};
