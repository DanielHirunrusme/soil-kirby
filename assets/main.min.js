...
var settings=require("modules/settings"),slideshow=require("modules/slideshow");module.exports=function(o){function e(){console.log("%c [video init]","color:blue");var o="";s.find("source").each(function(){$(this).attr("src").indexOf("hd.mp4")>=0&&(o=$(this).attr("src"))});var e=n.find("source").attr("src");s.find("video").attr("src",o);var a={};a.muted=!$("body").hasClass("single-slideshow"),a.autoplay=!0,a.controls=!1,a.hls={withCredentials:!0},$(".video-positioner").on("click",function(){console.log("mousedown")}),$(".play-button").on("click mouseup touchdown",function(o){o.stopPropagation(),console.log("play mobile video"),c.play(),c.requestFullscreen()}),console.log("src "+e),console.log("vidID "+l);var c=window.player=videojs(l,a);return c.on("ready",function(){console.log("player ready"),$("body").hasClass("home")?s.closest(".project-block").hasClass("active")&&(c.play(),t=!0):(c.play(),t=!0)}),c.on("pause",function(){$("body").hasClass("slideshow")||$("html").hasClass("touch")||c.play()}),c.on("timeupdate",function(){var o=c.currentTime(),e=c.duration();o==e&&(i||(i=!0,c.trigger("ended")))}),c.on("ended",function(){i&&(console.log("player ended 1"),$("body").hasClass("slideshow")&&s.closest(".video-block").hasClass("active")&&slideshow.nextBlock(),setTimeout(function(){i=!1},1e3))}),!0;var c}var s=$(o),n=($(window),$(".block").length-1,s.find("video")),l=n.attr("id"),t=!1,i=!1;e()};
