...
var settings=require("modules/settings");module.exports=function(o){function t(){console.log("%c [video init]","color:blue");var o="";i.find("source").each(function(){$(this).attr("data-src").indexOf("hd.mp4")>=0&&(o=$(this).attr("data-src"))}),i.find("video").attr("src",o);var t={};videojs.options.autoplay=!0,t.controls=!0,$(".video-positioner").on("click",function(){console.log("mousedown")}),$(".play-button").on("click mouseup touchdown",function(o){o.stopPropagation(),console.log("play mobile video"),s.play(),s.requestFullscreen()});var s=videojs(n,t,function(){videojs.log("Your player is ready!");this.options.poster=i.data("poster"),!settings.isMobile;var o="";i.find("source").each(function(){$(this).attr("data-src").indexOf("hd.mp4")>=0&&(o=$(this).attr("data-src"))}),console.log(o),i.find("video").attr("src",o),this.play(),this.on("ended",function(){videojs.log("Awww...over so soon?!")})})}var i=$(o),n=($(window),$(".block").length-1,i.attr("id"));t()};
},{"modules/settings":"modules/settings"}],"modules/wheel-container":[function(require,module,exports){
