...
},{"./lib/init-modules.js":6}],"modules/barba":[function(require,module,exports){
...
},{"barba.js":1,"modules/settings":"modules/settings","modules/shop":"modules/shop"}],"modules/blur-content":[function(require,module,exports){
module.exports=function(o){function n(){$("html").hasClass("touch")||$('*[data-blur="content"]').on("mouseover",t).on("mouseout",u)}function t(){$("body").addClass("blur-content")}function u(){$("body").removeClass("blur-content")}$(o),$(window);n()};
},{}],"modules/body":[function(require,module,exports){
var session=require("modules/session");module.exports=function(s){function e(){session.init()}e()};
},{"modules/session":"modules/session"}],"modules/cart-count":[function(require,module,exports){
...
},{"modules/settings":"modules/settings","modules/throttle":"modules/throttle"}],"modules/homepage":[function(require,module,exports){
var slideshow=require("modules/slideshow");module.exports=function(o){function s(){console.log("%c [homepage.init]","color:blue"),slideshow.init(),slideshow.setBlocks($(".project-block").toArray()),$("html").hasClass("touch")||slideshow.showSlideshow()}s()};
},{"modules/slideshow":"modules/slideshow"}],"modules/hypher":[function(require,module,exports){
module.exports=function(o){function e(){console.log("%c [hypher.init]","color:blue"),$("p, h1").hyphenate()}$(o);e()};
},{}],"modules/lazyload":[function(require,module,exports){
module.exports=function(n){function o(){}o()};
},{}],"modules/menu":[function(require,module,exports){
var settings=require("modules/settings"),throttle=require("modules/throttle"),cart=require("modules/cart"),menu=module.exports={hamburger:$("#main-hamburger"),menuTimer:0,init:function(){menu.hamburger.on("click",menu.toggleMenu),$(".site-header__logo-link").on("click",menu.logoClick),$(".site-nav a").length>0&&$(".site-nav a").on("click",menu.toggleSiteNav)},logoClick:function(e){e.preventDefault(),console.log("logoClick"),cart.hide(),$("body").hasClass("menu-open")?menu.hideMenu():$(settings.scrollContainer).animate({scrollTop:0},1e3,"easeInOutCubic")},toggleMenu:function(e){e.preventDefault(),console.log(settings.page.current),"product"==settings.page.current||($("body").hasClass("menu-open")?menu.hideMenu():menu.showMenu())},toggleSiteNav:function(e){e.preventDefault(),console.log("click"),$(e.currentTarget).parent().find(".site-nav__page-content").length>0&&($(e.currentTarget).parent().hasClass("open")?$(e.currentTarget).parent().removeClass("open"):($(".site-nav li.open").removeClass("open"),$(e.currentTarget).parent().addClass("open")))},showMenu:function(){$("#shopify-section-frontpage-collection").scrollTop()+2*$(window).height()>$("#shopify-section-frontpage-collection")[0].scrollHeight?$("#shopify-section-frontpage-collection").addClass("animate-height"):$("#shopify-section-frontpage-collection").removeClass("animate-height"),$(".main__logo-link").removeClass("over clicked"),$("body").addClass("menu-open"),this.hamburger.addClass("menu-open"),$(window).on("click",menu.windowClickMenu);$("#shopify-section-frontpage-collection").removeClass("animating-out")},hideMenu:function(){$(window).off("click",menu.windowClickMenu),$("body").removeClass("menu-open"),this.hamburger.removeClass("menu-open"),$(".site-nav li.open").removeClass("open"),$("#shopify-section-frontpage-collection").scrollTop()+2*$(window).height()>$("#shopify-section-frontpage-collection")[0].scrollHeight?$("#shopify-section-frontpage-collection").addClass("animate-height"):$("#shopify-section-frontpage-collection").removeClass("animate-height"),$("#shopify-section-frontpage-collection").addClass("animating-out"),clearTimeout(menu.menuTimer),menu.menuTimer=setTimeout(function(){$("#shopify-section-frontpage-collection").removeClass("animating-out")},1e3)},windowClickMenu:function(e){e.clientX>$(window).width()/2&&menu.hideMenu()}};
},{"modules/cart":"modules/cart","modules/settings":"modules/settings","modules/throttle":"modules/throttle"}],"modules/mobile-product-photos":[function(require,module,exports){
...
},{}],"modules/newsletter":[function(require,module,exports){
module.exports=function(o){function n(){console.log("%c [newsletter.init]","color:blue"),t.on("click",e)}function e(){l.find("form").toggleClass("show")}var l=$(o),t=($(window),l.find(".show-newsletter-form"));n()};
},{}],"modules/page":[function(require,module,exports){
var slideshow=require("modules/slideshow");module.exports=function(i){function s(){console.log("%c [homepage.init]","color:blue"),$("body").hasClass("writing")||(t(),slideshow.init(),slideshow.setBlocks($("figure").toArray()),$(".close").on("click",function(i){i.preventDefault(),slideshow.hideSlideshow()}))}function t(){var i=0,s='<div class="caption"><div class="caption-inner"><div class="text"><div class="caption-text"><div class="controls"><button class="ignore-slideshow prev">Prev</button>, <button class="ignore-slideshow next">Next</button></div><p><span class="caption-description" data-original=""></span></p></div></div></div></div>';$("figure").each(function(){$(this).attr("data-id",i),$(this).append(s),$figCaption=$(this).find("figCaption"),$(this).find(".caption-description").append($figCaption.text()).attr("data-original",$figCaption.text()),$(this).find("img").wrap('<div class="block-holder"></div>'),$figCaption.remove(),i++}),$("figure").addClass("project-block").attr("data-fit-browser","1").attr("data-ratio","1"),$("figure").first().addClass("first active"),$("html").hasClass("touch")||$("figure").on("click",function(i){$("body").hasClass("slideshow")||(slideshow.setBlock($(this).data("id")),slideshow.showSlideshow())})}s()};
},{"modules/slideshow":"modules/slideshow"}],"modules/product-scroll":[function(require,module,exports){
...
var settings=require("modules/settings");module.exports=function(t){function e(){$('*[data-fade="in"]').each(function(){var t=$(this);setTimeout(function(){t.addClass("fade-in")},200)}),p.on("resize",g),f.closest(".main-content").on("scroll",u),h.on("click",c).on("mouseover",s).on("mouseout",l),i(),o(),a(),d(),n()}function i(){$(".main-content").css("height",p.height())}function n(){for(var t=[],e=0;e<$(".grid__item-image").length;e++)t.push($(".grid__item-image").eq(e).attr("data-large-src"));for(var i=[],e=0;e<t.length;e++)!function(t,i){var n=new Image;n.id=e,n.onload=function(){i.resolve(),$(".grid__item-image").eq(n.id).attr("src",$(".grid__item-image").eq(n.id).attr("data-large-src")).addClass("loaded"),$(".grid__item-image").eq(n.id).closest(".grid__item").addClass("loaded")},n.src=t}(t[e],i[e]=$.Deferred());$.when.apply($,i).done(function(){})}function o(){$(".product-description-container").css("height",$(".product-description-inner-container").height()).css("top",$(window).height()/2-$(".product-description-container").height()/2)}function a(){$(".variant-label").on("touchstart click",r),$(".hover").off("touchstart touchend").on("touchstart touchend",function(t){t.preventDefault(),$(this).toggleClass("hover_effect")})}function r(t){if(console.log("variant click"),t.stopPropagation(),t.preventDefault(),!$(t.currentTarget).hasClass("selected")){var e=$(t.currentTarget).closest("li"),i=e.closest(".product-variants"),n=(e.attr("data-variant-id"),e.attr("data-variant-title")),o=i.closest(".product-variant").index(),a=$(".selector-wrapper").eq(o);a.find('select option[value="'+n+'"]').prop("selected","selected").change(),i.find(".variant-label.selected").removeClass("selected"),$(t.currentTarget).addClass("selected"),i.find('input[type="radio"]').attr("checked",!1),e.find('input[type="radio"]').attr("checked",!0).trigger("click")}}function c(t){console.log("-------------click------------"),t.preventDefault(),$(".main__logo-link").addClass("clicked"),$(".product__logo-link").addClass("clicked")}function s(){$(".main__logo-link").addClass("over")}function l(){$(".main__logo-link").removeClass("over")}function d(){}function u(){var t=$(".main__logo-link").height()+$(".main__logo-link").position().top;$(".product-single").offset().top<t}function g(){i(),o()}var f=$(t),p=$(window),h=$(".product__logo-link");e()};
},{"modules/settings":"modules/settings"}],"modules/project":[function(require,module,exports){
var settings=require("modules/settings"),slideshow=require("modules/slideshow");module.exports=function(e){function t(){console.log("%c [project.init]","color:blue"),$("body").hasClass("writing")||(u.on("click",a),m.on("click",w),$(".close").attr("href",$(".project_link").data("url")).on("click",c),slideshow.init(),slideshow.setBlocks($(".project-block").toArray()),$("body").hasClass("single-slideshow")&&slideshow.showSlideshow(),$("html").hasClass("touch")?slideshow.showMobileSlideshow():($(".project-block").on("click",d),$(window).on("scroll",i),i()),$(window).on("resize",g))}function i(){return!!$("html").hasClass("touch")||($("body").hasClass("overview")&&(C=$(window).scrollTop()),console.log("project scroll"),$(".related .inner").height()>p.height()-f/2?s():o(),$(".text .inner").height()>p.height()-f/2?n():r(),void($(".project-images .container").height()>p.height()-f/2?h():l()))}function s(){return!($(".related .inner").height()>$(".project-images .container").height()&&$(".related .inner").height()>$(".text .inner").height())&&void($(".related .inner").height()>p.height()?p.scrollTop()>$(".related .inner").height()-p.height()+f+x?$(".related .inner").addClass("fixed").css("width",$(".related").width()-v):$(".related .inner").removeClass("fixed").css("width",""):p.scrollTop()<f-x&&$(".related .inner").removeClass("fixed").css("width","").css("top",""))}function o(){p.scrollTop()>f-x?$(".related .inner").addClass("fixed top").css("width",$(".related").width()-v).css("top",x):$(".related .inner").removeClass("fixed top").css("width","").css("top","")}function n(){return!($(".text .inner").height()>$(".related .inner").height()&&$(".text .inner").height()>$(".project-images .container").height())&&void($(".text .inner").height()>p.height()?p.scrollTop()>$(".text .inner").height()-p.height()+f+x?$(".text .inner").addClass("fixed").css("width",$(".text").width()-v):$(".text .inner").removeClass("fixed top").css("width",""):p.scrollTop()<f-x&&$(".text .inner").removeClass("fixed").css("width",""))}function r(){p.scrollTop()>f-x?$(".text .inner").addClass("fixed top").css("width",$(".text").width()-v):$(".text .inner").removeClass("fixed top").css("width","")}function h(){return!($(".project-images .container").height()>$(".related .inner").height()&&$(".project-images .container").height()>$(".text .inner").height())&&void(p.scrollTop()>$(".project-images .container").height()-p.height()+f+x?$(".project-images .container").addClass("fixed").css("width",$(".project-images").width()):$(".project-images .container").removeClass("fixed top").css("width",""))}function l(){p.scrollTop()>f/2?$(".project-images .container").addClass("fixed").css("width",$(".project-images").width()):$(".project-images .container").removeClass("fixed top").css("width","")}function d(e){$("body").hasClass("slideshow")||(slideshow.setBlock($(e.currentTarget).index()),slideshow.showSlideshow(),console.log("scrollPos "+C))}function c(e){$("body").hasClass("overview")}function a(e){e.preventDefault(),slideshow.hideSlideshow(),$("body").addClass("overview")}function w(e){e.preventDefault(),slideshow.showSlideshow(),$("body").removeClass("overview")}function g(){x=$(".dummy-box").height(),f=$(".content-inner").position().top,v=$(".related .inner").outerWidth()-$(".related .inner").width(),$("body").hasClass("slideshow")||$("html").hasClass("slideshow")||$("html").hasClass("touch")||i()}var p=($(e),$(window)),u=$(".overview-btn"),m=$(".images-btn"),x=$(".dummy-box").height(),f=$(".content-inner").position().top,v=$(".related .inner").outerWidth()-$(".related .inner").width(),C=0;t()};
},{"modules/settings":"modules/settings","modules/slideshow":"modules/slideshow"}],"modules/session":[function(require,module,exports){
var session=module.exports={init:function(){console.log("%c [session.init]","color:blue")},setSession:function(){},getSession:function(){}};
...
var shop=module.exports={$window:$(window),init:function(){console.log("shop init"),shop.attachItemEvents(),shop.preloadImages()},preloadImages:function(){for(var e=[],i=0;i<$(".grid__item-image").length;i++)e.push($(".grid__item-image").eq(i).attr("src"));for(var o=[],i=0;i<e.length;i++)!function(e,o){var t=new Image;t.id=i,t.onload=function(){o.resolve(),$(".grid__item-image").eq(t.id).closest(".grid__item").addClass("loaded")},t.src=e}(e[i],o[i]=$.Deferred());$.when.apply($,o).done(function(){})},attachItemEvents:function(){$(".grid__item-image").on("mouseover",shop.gridItemOver).on("mouseout",shop.gridItemOut).on("click",shop.gridItemClick)},gridItemOver:function(e){$(e.currentTarget).closest(".grid__item").removeClass("disabled")},reset:function(){$(".grid__item.clicked").removeClass("clicked")},gridItemOut:function(e){$(".grid__item").removeClass("disabled")},gridItemClick:function(e){console.log("clicked"),$(e.currentTarget).closest(".grid__item").addClass("clicked"),$(".main__logo-link").removeClass("clicked over"),$("body").addClass("grid-item-clicked")}};
},{}],"modules/slideshow":[function(require,module,exports){
var settings=require("modules/settings"),throttle=require("modules/throttle"),ellipsis=require("ellipsis.js"),slick=require("slick-carousel"),mousewheel=require("jquery-mousewheel"),slideshow=module.exports={blocks:[],currBlock:0,totalBlocks:0,$window:$(window),body_padding:$(".dummy-box").height(),deltas:[null,null,null,null,null,null,null,null,null],lock:0,isSlick:!1,slickSlider:null,timerInt:null,timerTimeout:null,init:function(){console.log("%c [slideshow.init]","color:blue")},setBlocks:function(s){slideshow.blocks=s,slideshow.totalBlocks=slideshow.blocks.length-1,0==slideshow.totalBlocks&&$(".controls").addClass("single"),$("html").hasClass("touch")&&!$("body").hasClass("default")&&($("body").addClass("slick-slideshow"),slideshow.initSlick())},showSlideshow:function(){$("body").addClass("slideshow"),$("body").removeClass("overview"),$(".overview-btn").removeClass("active"),$(".images-btn").addClass("active"),$(".project-images .container").removeClass("fixed top").css("width",""),slideshow.switchTextColor(),slideshow.setBackgrounds(),$("body").hasClass("single-slideshow")?slideshow.initMobileVideo():($(slideshow.blocks[slideshow.currBlock]).hasClass("video-block")||slideshow.initTimer(),slideshow.setCaptions(),slideshow.initControls()),slideshow.isSlick&&$(".project-images .inner").slick("setPosition"),$(window).on("resize",throttle(slideshow.winResize,300))},initTimer:function(){clearInterval(slideshow.timerInt),slideshow.timerInt=setInterval(slideshow.nextBlock,4e3)},pauseTimer:function(){console.log("pauseTimer"),clearInterval(slideshow.timerInt),clearTimeout(slideshow.timerTimeout),slideshow.timerTimeout=setTimeout(slideshow.initTimer,8e3)},clearTimer:function(){console.log("clearTimer"),clearInterval(slideshow.timerInt),clearTimeout(slideshow.timerTimeout)},initMobileVideo:function(){},showMobileSlideshow:function(){slideshow.hideSlideshow()},initSlick:function(){console.log("%c [initSlick]","color:blue"),$(".block-holder").each(function(){var s;s=$(this).find("video").length>0?$(this).find(".video-positioner").data("poster"):$(this).find("img").attr("src"),$(this).css("background-image","url("+s+")")}),slideshow.isSlick=!0,$("body").hasClass("overview")||slideshow.switchTextColor(),$(".project-images .inner").on("init",function(s,i){$(".slick-arrow").on("click",function(){$(".slick-slider").addClass("is-swiping")})}),$(".project-images .inner").slick({dots:!1,arrows:!0,speed:500,adaptiveHeight:!1,infinite:!1,mobileFirst:!0}).on("beforeChange",function(s,i,o,e){slideshow.currBlock=e,console.log("sliding"),$("body").hasClass("overview")||slideshow.switchTextColor()}).on("touchmove.slick",function(){console.log("touchmove.slick"),$(".slick-slider").addClass("is-swiping")}).on("afterChange",function(){$(".slick-slider").removeClass("is-swiping"),slideshow.setCaptions()}),slideshow.setCaptions()},hideSlideshow:function(){$("body").hasClass("single-slideshow")||($("body").removeClass("slideshow black-text white-text"),$("body").addClass("overview"),$(".overview-btn").addClass("active"),$(".images-btn").removeClass("active"),slideshow.unsetBackgrounds(),slideshow.destroyControls(),slideshow.unsetCaptions(),$(".video-block").each(function(){var s=$(this).find("video").attr("id"),i=videojs(s);i.currentTime(0),i.play()}),slideshow.isSlick&&$(".project-images .inner").slick("setPosition"),$(window).off("resize",slideshow.winResize))},initControls:function(){console.log("init controls"),$(".controls .prev").on("click",slideshow.prevClick),$(".controls .next").on("click",slideshow.nextClick),slideshow.initArrows(),$(window).on("mousedown",slideshow.winDown),$(window).on("mousewheel",slideshow.winWheel)},destroyControls:function(){$(".controls .prev").off("click"),$(".controls .next").off("click"),$(window).off("mousedown",slideshow.winDown),$(window).off("mousewheel",slideshow.winWheel)},initArrows:function(){$(document).keydown(function(s){if($("body").hasClass("slideshow"))switch(s.originalEvent.keyCode){case 37:slideshow.prevBlock();break;case 39:slideshow.nextBlock()}})},closeClick:function(){},prevClick:function(){slideshow.prevBlock()},nextClick:function(){slideshow.nextBlock()},prevBlock:function(){console.log("prev block"),slideshow.currBlock=slideshow.currBlock>0?slideshow.currBlock-1:slideshow.totalBlocks,slideshow.switchBlock()},nextBlock:function(){console.log("next block"),slideshow.currBlock=slideshow.currBlock<slideshow.totalBlocks?slideshow.currBlock+1:0,slideshow.switchBlock()},switchBlock:function(){if($("html").hasClass("touch"))return!0;if(console.log("switch block"),$(slideshow.blocks).removeClass("active first"),$(slideshow.blocks[slideshow.currBlock]).addClass("active"),slideshow.switchTextColor(),$(".video-block").each(function(){var s=$(this).find("video").attr("id"),i=videojs(s);i.currentTime(0),i.pause()}),$(slideshow.blocks[slideshow.currBlock]).hasClass("video-block")){var s=$(slideshow.blocks[slideshow.currBlock]).find("video").attr("id"),i=videojs(s);i.currentTime(.1),i.play(),console.log(i),slideshow.clearTimer()}$(slideshow.blocks[slideshow.currBlock]).hasClass("video-block")||slideshow.initTimer()},switchTextColor:function(){color=$(slideshow.blocks[slideshow.currBlock]).data("text-color"),$("body").removeClass("black-text white-text").addClass(color+"-text")},setBlock:function(s){slideshow.currBlock=s,slideshow.switchBlock()},setBackgrounds:function(){$(slideshow.blocks).each(function(){var s=$(this).data("fit-browser");"0"==s?$(this).find(".video-positioner").length>0?slideshow.fitImage($(this).find(".video-positioner"),$(this).find(".video-positioner").data("ratio")):slideshow.fitImage($(this).find("img"),$(this).data("ratio")):$(this).find(".video-positioner").length>0?slideshow.fullBleed($(this).find(".video-positioner"),$(this).find(".video-positioner").data("ratio")):slideshow.fullBleed($(this).find("img"),$(this).data("ratio"))})},fullBleed:function(s,i){console.log("full bleed");var o=$(window).height(),e=o*i,l=$(window).width()/2-e/2,t=$(window).height()/2-o/2;e<$(window).width()&&(console.log("make bigger"),e=$(window).width(),o=e/i,l=$(window).width()/2-e/2,t=$(window).height()/2-o/2),$(s).css({height:o,width:e,left:l,top:t})},fitImage:function(s,i){var o=3.5*$(".main-nav").height(),e=$(".caption-text").length>0?$(".caption-text").height():$(".main-nav").height();e/2>=$(".main-nav").height()&&(o=2*$(".main-nav").height()+e);var l=$(window).height()-2*o,t=l*i,n=$(window).width()/2-t/2,d=$(window).height()/2-l/2-(e-$(".main-nav").height())/2;t>$(window).width()&&(t=$(window).width()-2*slideshow.body_padding,l=t/i,n=$(window).width()/2-t/2,d=$(window).height()/2-l/2),$(s).css({height:l,width:t,left:n,top:d})},unsetBackgrounds:function(){$(slideshow.blocks).each(function(){$(this).find("img").css({height:"",width:"",left:"",top:""}),$(this).find(".video-positioner").css({height:"",width:"",left:"",top:""})})},setCaptions:function(){console.log("setCaptions");Ellipsis({ellipsis:"[…]",debounce:0,responsive:!1,"class":".caption-description",lines:2,portrait:null,break_word:!1});$(".caption-description").each(function(){$(this).attr("data-ellipsis",$(this).text())}),$(".caption-text p").on("mouseover click",function(s){s.stopPropagation(),$(this).find(".caption-description").text($(this).find(".caption-description").data("original"))}).on("mouseout",function(){Ellipsis({ellipsis:"[…]",debounce:0,responsive:!1,"class":".caption-description",lines:2,portrait:null,break_word:!1})})},unsetCaptions:function(){$(".caption-text p").off("mouseover mouseout"),$(".caption-text p").each(function(){$(this).find(".caption-description").text($(this).find(".caption-description").data("original"))})},winDown:function(s){return!!$(s.target).hasClass("ignore-slideshow")||void(s.clientX<$(window).width()/2?(slideshow.pauseTimer(),slideshow.prevBlock()):(slideshow.pauseTimer(),slideshow.nextBlock()))},winResize:function(){$("body").hasClass("slideshow")?(slideshow.setBackgrounds(),slideshow.setCaptions()):slideshow.unsetCaptions()},winWheel:function(s){s.preventDefault();var i=0;i="mousewheel"==s.type?s.originalEvent.wheelDeltaY*-1:40*s.originalEvent.detail,slideshow.hasPeak()?(slideshow.lock=10,slideshow.fire(s)):null!=slideshow.deltas[8]&&120!=slideshow.deltas[8]||120!=Math.abs(slideshow.delta)||slideshow.fire(s),slideshow.deltas.shift(),slideshow.deltas.push(Math.abs(i))},fire:function(s){s.deltaY<0?slideshow.nextBlock():slideshow.prevBlock()},hasPeak:function(){return slideshow.lock>0?(slideshow.lock-=.38,!1):null!=slideshow.deltas[0]&&(slideshow.deltas[0]<slideshow.deltas[4]&&slideshow.deltas[1]<=slideshow.deltas[4]&&slideshow.deltas[2]<=slideshow.deltas[4]&&slideshow.deltas[3]<=slideshow.deltas[4]&&slideshow.deltas[5]<=slideshow.deltas[4]&&slideshow.deltas[6]<=slideshow.deltas[4]&&slideshow.deltas[7]<=slideshow.deltas[4]&&slideshow.deltas[8]<slideshow.deltas[4]&&slideshow.hasPeak)}};
},{"ellipsis.js":2,"jquery-mousewheel":3,"modules/settings":"modules/settings","modules/throttle":"modules/throttle","slick-carousel":5}],"modules/throttle":[function(require,module,exports){
...
var settings=require("modules/settings"),slideshow=require("modules/slideshow");module.exports=function(o){function e(){console.log("%c [video init]","color:blue");var o="";s.find("source").each(function(){$(this).attr("src").indexOf("hd.mp4")>=0&&(o=$(this).attr("src"))});var e=l.find("source").attr("src");s.find("video").attr("src",o);var a={};a.muted=!$("body").hasClass("single-slideshow"),a.autoplay=!0,a.controls=!1,a.hls={withCredentials:!0},$(".video-positioner").on("click",function(){console.log("mousedown")}),$(".play-button").on("click mouseup touchdown",function(o){o.stopPropagation(),console.log("play mobile video"),c.play(),c.requestFullscreen()}),console.log("src "+e),console.log("vidID "+n);var c=window.player=videojs(n,a);return c.on("ready",function(){console.log("player ready"),$("body").hasClass("home")?s.closest(".project-block").hasClass("active")&&(c.play(),t=!0):(c.play(),t=!0),$("html").hasClass("touch")&&(c.pause(),t=!1)}),c.on("pause",function(){$("body").hasClass("slideshow")||$("html").hasClass("touch")||c.play()}),c.on("timeupdate",function(){var o=c.currentTime(),e=c.duration();console.log(o),console.log(e),o>=e-.5&&(i||(i=!0,c.trigger("ended")))}),c.on("ended",function(){i&&(console.log("player ended 1"),$("body").hasClass("slideshow")&&s.closest(".video-block").hasClass("active")&&slideshow.nextBlock(),setTimeout(function(){i=!1},1e3))}),!0;var c}var s=$(o),l=($(window),$(".block").length-1,s.find("video")),n=l.attr("id"),t=!1,i=!1;e()};
},{"modules/settings":"modules/settings","modules/slideshow":"modules/slideshow"}],"modules/wheel-container":[function(require,module,exports){
var mousewheel=require("jquery-mousewheel")($),settings=require("modules/settings");module.exports=function(e){function o(e){e.stopPropagation(),e.clientX<=i.position().left+i.outerWidth()&&e.clientX>=i.position().left&&!settings.isMobile&&(e.preventDefault(),$(l).scrollTop($(l).scrollTop()-e.deltaY))}function t(){settings.isMobile&&s.off("mousewheel",o)}var i=$(e),s=$(window),l="#"+i.data("scroll-container");s.width()>900?s.off("mousewheel",o).on("mousewheel",o):s.off("mousewheel",o),s.on("resize",t)};
},{"jquery-mousewheel":3,"modules/settings":"modules/settings"}]},{},[7])
