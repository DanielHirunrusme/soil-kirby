...
var settings=require("modules/settings"),slideshow=require("modules/slideshow");module.exports=function(e){function i(){console.log("%c [project.init]","color:blue"),$("body").hasClass("writing")||(u.on("click",a),f.on("click",w),$(".close").attr("href",$(".project_link").data("url")).on("click",c),slideshow.init(),slideshow.setBlocks($(".project-block").toArray()),slideshow.showSlideshow(),$("html").hasClass("touch")||($(".project-block").on("click",d),$(window).on("scroll",t),t()),$(window).on("resize",g))}function t(){$("body").hasClass("overview")&&(C=$(window).scrollTop()),$(".related .inner").height()>p.height()-x/2?o():s(),$(".text .inner").height()>p.height()-x/2?n():r(),$(".project-images .container").height()>p.height()-x/2?h():l()}function o(){return!($(".related .inner").height()>$(".project-images .container").height()&&$(".related .inner").height()>$(".text .inner").height())&&void(p.scrollTop()>$(".related .inner").height()-p.height()+x+m?$(".related .inner").addClass("fixed").css("width",$(".related").width()-v):$(".related .inner").removeClass("fixed").css("width",""))}function s(){p.scrollTop()>x/2?$(".related .inner").addClass("fixed top").css("width",$(".related").width()-v):$(".related .inner").removeClass("fixed top").css("width","")}function n(){return!($(".text .inner").height()>$(".related .inner").height()&&$(".text .inner").height()>$(".project-images .container").height())&&void(p.scrollTop()>$(".text .inner").height()-p.height()+x+m?$(".text .inner").addClass("fixed").css("width",$(".text").width()-v):$(".text .inner").removeClass("fixed top").css("width",""))}function r(){p.scrollTop()>x/2?$(".text .inner").addClass("fixed top").css("width",$(".text").width()-v):$(".text .inner").removeClass("fixed top").css("width","")}function h(){return!($(".project-images .container").height()>$(".related .inner").height()&&$(".project-images .container").height()>$(".text .inner").height())&&void(p.scrollTop()>$(".project-images .container").height()-p.height()+x+m?$(".project-images .container").addClass("fixed").css("width",$(".project-images").width()):$(".project-images .container").removeClass("fixed top").css("width",""))}function l(){p.scrollTop()>x/2?$(".project-images .container").addClass("fixed").css("width",$(".project-images").width()):$(".project-images .container").removeClass("fixed top").css("width","")}function d(e){$("body").hasClass("slideshow")||(slideshow.setBlock($(e.currentTarget).index()),slideshow.showSlideshow(),console.log("scrollPos "+C))}function c(e){$("body").hasClass("slideshow")&&(e.preventDefault(),slideshow.hideSlideshow(),console.log("scroll to "+C),$(window).scrollTop(C))}function a(e){e.preventDefault(),slideshow.hideSlideshow(),$("body").addClass("overview")}function w(e){e.preventDefault(),slideshow.showSlideshow(),$("body").removeClass("overview")}function g(){$("body").hasClass("slideshow")||$("html").hasClass("slideshow")||t()}var p=($(e),$(window)),u=$(".overview-btn"),f=$(".images-btn"),m=$(".dummy-box").height(),x=$(".content-inner").position().top,v=$(".related .inner").outerWidth()-$(".related .inner").width(),C=0;i()};
