...
var settings=require("modules/settings");module.exports=function(o){function t(){console.log("%c [video init]","color:blue");var o="";i.find("source").each(function(){$(this).attr("data-src").indexOf("hd.mp4")>=0&&(o=$(this).attr("data-src"))}),i.find("video").attr("src",o);var t={};videojs.options.autoplay=!0;videojs(s,t,function(){videojs.log("Your player is ready!");var o=this;$(".play-button").on("click",function(){console.log("play mobile video"),o.play()}),this.options.poster=i.data("poster"),!settings.isMobile;var t="";i.find("source").each(function(){$(this).attr("data-src").indexOf("hd.mp4")>=0&&(t=$(this).attr("data-src"))}),console.log(t),i.find("video").attr("src",t),this.play(),this.on("ended",function(){videojs.log("Awww...over so soon?!")})})}var i=$(o),s=($(window),$(".block").length-1,i.attr("id"));t()};
