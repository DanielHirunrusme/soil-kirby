...
var settings=require("modules/settings"),throttle=require("modules/throttle"),ellipsis=require("ellipsis.js"),slick=require("slick-carousel"),mousewheel=require("jquery-mousewheel"),slideshow=module.exports={blocks:[],currBlock:0,totalBlocks:0,$window:$(window),body_padding:$(".dummy-box").height(),deltas:[null,null,null,null,null,null,null,null,null],lock:0,isSlick:!1,slickSlider:null,timerInt:null,timerTimeout:null,init:function(){console.log("%c [slideshow.init]","color:blue")},setBlocks:function(i){slideshow.blocks=i,slideshow.totalBlocks=slideshow.blocks.length-1,0==slideshow.totalBlocks&&$(".controls").addClass("single"),$("html").hasClass("touch")&&!$("body").hasClass("default")&&($("body").addClass("slick-slideshow"),slideshow.initSlick())},showSlideshow:function(){$("body").addClass("slideshow"),$("body").removeClass("overview"),$(".overview-btn").removeClass("active"),$(".images-btn").addClass("active"),$(".project-images .container").removeClass("fixed top").css("width",""),slideshow.setBackgrounds(),$("body").hasClass("single-slideshow")?slideshow.initMobileVideo():($(slideshow.blocks[slideshow.currBlock]).hasClass("video-block")||slideshow.initTimer(),slideshow.setCaptions(),slideshow.initControls()),slideshow.isSlick&&$(".project-images .inner").slick("setPosition"),$(window).on("resize",throttle(slideshow.winResize,300))},initTimer:function(){clearInterval(slideshow.timerInt),slideshow.timerInt=setInterval(slideshow.nextBlock,4e3)},pauseTimer:function(){console.log("pauseTimer"),clearInterval(slideshow.timerInt),clearTimeout(slideshow.timerTimeout),slideshow.timerTimeout=setTimeout(slideshow.initTimer,8e3)},clearTimer:function(){console.log("clearTimer"),clearInterval(slideshow.timerInt),clearTimeout(slideshow.timerTimeout)},initMobileVideo:function(){},showMobileSlideshow:function(){slideshow.hideSlideshow()},initSlick:function(){console.log("%c [initSlick]","color:blue"),$(".block-holder").each(function(){var i;i=$(this).find("video").length>0?$(this).find(".video-positioner").data("poster"):$(this).find("img").attr("src"),$(this).css("background-image","url("+i+")")}),slideshow.isSlick=!0,$("body").hasClass("overview")||slideshow.switchTextColor(),$(".project-images .inner").on("init",function(i,s){$(".slick-arrow").on("click",function(){$(".slick-slider").addClass("is-swiping")})}),$(".project-images .inner").slick({dots:!1,arrows:!0,speed:500,adaptiveHeight:!1,infinite:!1,mobileFirst:!0}).on("beforeChange",function(i,s,o,e){slideshow.currBlock=e,console.log("sliding"),$("body").hasClass("overview")||slideshow.switchTextColor()}).on("touchmove.slick",function(){console.log("touchmove.slick"),$(".slick-slider").addClass("is-swiping")}).on("afterChange",function(){$(".slick-slider").removeClass("is-swiping")}),slideshow.setCaptions()},hideSlideshow:function(){$("body").hasClass("single-slideshow")||($("body").removeClass("slideshow black-text white-text"),$("body").addClass("overview"),$(".overview-btn").addClass("active"),$(".images-btn").removeClass("active"),slideshow.unsetBackgrounds(),slideshow.destroyControls(),slideshow.unsetCaptions(),$(".video-block").each(function(){var i=$(this).find("video").attr("id"),s=videojs(i);s.currentTime(0),s.play()}),slideshow.isSlick&&$(".project-images .inner").slick("setPosition"),$(window).off("resize",slideshow.winResize))},initControls:function(){console.log("init controls"),$(".controls .prev").on("click",slideshow.prevClick),$(".controls .next").on("click",slideshow.nextClick),slideshow.initArrows(),$(window).on("mousedown",slideshow.winDown),$(window).on("mousewheel",slideshow.winWheel)},destroyControls:function(){$(".controls .prev").off("click"),$(".controls .next").off("click"),$(window).off("mousedown",slideshow.winDown),$(window).off("mousewheel",slideshow.winWheel)},initArrows:function(){$(document).keydown(function(i){if($("body").hasClass("slideshow"))switch(i.originalEvent.keyCode){case 37:slideshow.prevBlock();break;case 39:slideshow.nextBlock()}})},closeClick:function(){},prevClick:function(){slideshow.prevBlock()},nextClick:function(){slideshow.nextBlock()},prevBlock:function(){console.log("prev block"),slideshow.currBlock=slideshow.currBlock>0?slideshow.currBlock-1:slideshow.totalBlocks,slideshow.switchBlock()},nextBlock:function(){console.log("next block"),slideshow.currBlock=slideshow.currBlock<slideshow.totalBlocks?slideshow.currBlock+1:0,slideshow.switchBlock()},switchBlock:function(){if(console.log("switch block"),$(slideshow.blocks).removeClass("active first"),$(slideshow.blocks[slideshow.currBlock]).addClass("active"),slideshow.switchTextColor(),$(".video-block").each(function(){var i=$(this).find("video").attr("id"),s=videojs(i);s.currentTime(0),s.pause()}),$(slideshow.blocks[slideshow.currBlock]).hasClass("video-block")){var i=$(slideshow.blocks[slideshow.currBlock]).find("video").attr("id"),s=videojs(i);s.currentTime(.1),s.play(),console.log(s),slideshow.clearTimer()}$(slideshow.blocks[slideshow.currBlock]).hasClass("video-block")||slideshow.initTimer()},switchTextColor:function(){color=$(slideshow.blocks[slideshow.currBlock]).data("text-color"),$("body").removeClass("black-text white-text").addClass(color+"-text")},setBlock:function(i){slideshow.currBlock=i,slideshow.switchBlock()},setBackgrounds:function(){$(slideshow.blocks).each(function(){var i=$(this).data("fit-browser");"0"==i?$(this).find(".video-positioner").length>0?slideshow.fitImage($(this).find(".video-positioner"),$(this).find(".video-positioner").data("ratio")):slideshow.fitImage($(this).find("img"),$(this).data("ratio")):$(this).find(".video-positioner").length>0?slideshow.fullBleed($(this).find(".video-positioner"),$(this).find(".video-positioner").data("ratio")):slideshow.fullBleed($(this).find("img"),$(this).data("ratio"))})},fullBleed:function(i,s){console.log("full bleed");var o=$(window).height(),e=o*s,l=$(window).width()/2-e/2,t=$(window).height()/2-o/2;e<$(window).width()&&(console.log("make bigger"),e=$(window).width(),o=e/s,l=$(window).width()/2-e/2,t=$(window).height()/2-o/2),$(i).css({height:o,width:e,left:l,top:t})},fitImage:function(i,s){var o=3.5*$(".main-nav").height(),e=$(".caption-text").length>0?$(".caption-text").height():$(".main-nav").height();e/2>=$(".main-nav").height()&&(o=2*$(".main-nav").height()+e);var l=$(window).height()-2*o,t=l*s,n=$(window).width()/2-t/2,d=$(window).height()/2-l/2-(e-$(".main-nav").height())/2;t>$(window).width()&&(t=$(window).width()-2*slideshow.body_padding,l=t/s,n=$(window).width()/2-t/2,d=$(window).height()/2-l/2),$(i).css({height:l,width:t,left:n,top:d})},unsetBackgrounds:function(){$(slideshow.blocks).each(function(){$(this).find("img").css({height:"",width:"",left:"",top:""}),$(this).find(".video-positioner").css({height:"",width:"",left:"",top:""})})},setCaptions:function(){Ellipsis({ellipsis:"[…]",debounce:0,responsive:!1,"class":".caption-description",lines:2,portrait:null,break_word:!1});$(".caption-description").each(function(){$(this).attr("data-ellipsis",$(this).text())}),$(".caption-text p").on("mouseover click",function(i){i.stopPropagation(),$(this).find(".caption-description").text($(this).find(".caption-description").data("original"))}).on("mouseout",function(){Ellipsis({ellipsis:"[…]",debounce:0,responsive:!1,"class":".caption-description",lines:2,portrait:null,break_word:!1})})},unsetCaptions:function(){$(".caption-text p").off("mouseover mouseout"),$(".caption-text p").each(function(){$(this).find(".caption-description").text($(this).find(".caption-description").data("original"))})},winDown:function(i){return!!$(i.target).hasClass("ignore-slideshow")||void(i.clientX<$(window).width()/2?(slideshow.pauseTimer(),slideshow.prevBlock()):(slideshow.pauseTimer(),slideshow.nextBlock()))},winResize:function(){$("body").hasClass("slideshow")?(slideshow.setBackgrounds(),slideshow.setCaptions()):slideshow.unsetCaptions()},winWheel:function(i){i.preventDefault();var s=0;s="mousewheel"==i.type?i.originalEvent.wheelDeltaY*-1:40*i.originalEvent.detail,slideshow.hasPeak()?(slideshow.lock=10,slideshow.fire(i)):null!=slideshow.deltas[8]&&120!=slideshow.deltas[8]||120!=Math.abs(slideshow.delta)||slideshow.fire(i),slideshow.deltas.shift(),slideshow.deltas.push(Math.abs(s))},fire:function(i){i.deltaY<0?slideshow.nextBlock():slideshow.prevBlock()},hasPeak:function(){return slideshow.lock>0?(slideshow.lock-=.38,!1):null!=slideshow.deltas[0]&&(slideshow.deltas[0]<slideshow.deltas[4]&&slideshow.deltas[1]<=slideshow.deltas[4]&&slideshow.deltas[2]<=slideshow.deltas[4]&&slideshow.deltas[3]<=slideshow.deltas[4]&&slideshow.deltas[5]<=slideshow.deltas[4]&&slideshow.deltas[6]<=slideshow.deltas[4]&&slideshow.deltas[7]<=slideshow.deltas[4]&&slideshow.deltas[8]<slideshow.deltas[4]&&slideshow.hasPeak)}};
