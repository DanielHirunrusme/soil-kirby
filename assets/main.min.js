...
var settings=require("modules/settings"),slideshow=require("modules/slideshow");module.exports=function(e){function i(){console.log("%c [project.init]","color:blue"),$("body").hasClass("writing")||(u.on("click",a),x.on("click",w),$(".close").attr("href",$(".project_link").data("url")).on("click",c),slideshow.init(),slideshow.setBlocks($(".project-block").toArray()),$("body").hasClass("single-slideshow")&&slideshow.showSlideshow(),$("html").hasClass("touch")?slideshow.showMobileSlideshow():($(".project-block").on("click",d),$(window).on("scroll",t),t()),$(window).on("resize",g))}function t(){$("body").hasClass("overview")&&(C=$(window).scrollTop()),console.log("project scroll"),$(".related .inner").height()>p.height()-m/2?s():o(),$(".text .inner").height()>p.height()-m/2?n():r(),$(".project-images .container").height()>p.height()-m/2?h():l()}function s(){return!($(".related .inner").height()>$(".project-images .container").height()&&$(".related .inner").height()>$(".text .inner").height())&&void($(".related .inner").height()>p.height()?p.scrollTop()>$(".related .inner").height()-p.height()+m+f?$(".related .inner").addClass("fixed").css("width",$(".related").width()-v):$(".related .inner").removeClass("fixed").css("width",""):p.scrollTop()<m-f&&$(".related .inner").removeClass("fixed").css("width","").css("top",""))}function o(){p.scrollTop()>m-f?$(".related .inner").addClass("fixed top").css("width",$(".related").width()-v).css("top",f):$(".related .inner").removeClass("fixed top").css("width","").css("top","")}function n(){return!($(".text .inner").height()>$(".related .inner").height()&&$(".text .inner").height()>$(".project-images .container").height())&&void($(".text .inner").height()>p.height()?p.scrollTop()>$(".text .inner").height()-p.height()+m+f?$(".text .inner").addClass("fixed").css("width",$(".text").width()-v):$(".text .inner").removeClass("fixed top").css("width",""):p.scrollTop()<m-f&&$(".text .inner").removeClass("fixed").css("width",""))}function r(){p.scrollTop()>m-f?$(".text .inner").addClass("fixed top").css("width",$(".text").width()-v):$(".text .inner").removeClass("fixed top").css("width","")}function h(){return!($(".project-images .container").height()>$(".related .inner").height()&&$(".project-images .container").height()>$(".text .inner").height())&&void(p.scrollTop()>$(".project-images .container").height()-p.height()+m+f?$(".project-images .container").addClass("fixed").css("width",$(".project-images").width()):$(".project-images .container").removeClass("fixed top").css("width",""))}function l(){p.scrollTop()>m/2?$(".project-images .container").addClass("fixed").css("width",$(".project-images").width()):$(".project-images .container").removeClass("fixed top").css("width","")}function d(e){$("body").hasClass("slideshow")||(slideshow.setBlock($(e.currentTarget).index()),slideshow.showSlideshow(),console.log("scrollPos "+C))}function c(e){$("body").hasClass("overview")}function a(e){e.preventDefault(),slideshow.hideSlideshow(),$("body").addClass("overview")}function w(e){e.preventDefault(),slideshow.showSlideshow(),$("body").removeClass("overview")}function g(){f=$(".dummy-box").height(),m=$(".content-inner").position().top,v=$(".related .inner").outerWidth()-$(".related .inner").width(),$("body").hasClass("slideshow")||$("html").hasClass("slideshow")||t()}var p=($(e),$(window)),u=$(".overview-btn"),x=$(".images-btn"),f=$(".dummy-box").height(),m=$(".content-inner").position().top,v=$(".related .inner").outerWidth()-$(".related .inner").width(),C=0;i()};
