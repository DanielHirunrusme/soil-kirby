...
var settings=require("modules/settings"),slideshow=require("modules/slideshow");module.exports=function(o){function e(){console.log("%c [video init]","color:blue");var o="";s.find("source").each(function(){$(this).attr("src").indexOf("hd.mp4")>=0&&(o=$(this).attr("src"))});var e=n.find("source").attr("src");s.find("video").attr("src",o);var r={};r.muted=!$("body").hasClass("single-slideshow"),r.autoplay=!0,r.controls=!1,r.hls={withCredentials:!0},$(".video-positioner").on("click",function(){console.log("mousedown")}),$(".play-button").on("click mouseup touchdown",function(o){o.stopPropagation(),console.log("play mobile video"),d.play(),d.requestFullscreen()}),console.log("src "+e),console.log("vidID "+i);var d=window.player=videojs(i,r);return d.on("ready",function(){console.log("player ready"),d.play(),l=!0}),d.on("pause",function(){$("body").hasClass("slideshow")||d.play()}),d.on("timeupdate",function(){var o=d.currentTime();d.duration();0==o&&(t||(t=!0,d.trigger("ended")))}),d.on("ended",function(){t&&(console.log("player ended 1"),$("body").hasClass("slideshow")&&s.closest(".video-block").hasClass("active")&&slideshow.nextBlock(),setTimeout(function(){t=!1},1e3))}),!0;var d}var s=$(o),n=($(window),$(".block").length-1,s.find("video")),i=n.attr("id"),l=!1,t=!1;e()};
