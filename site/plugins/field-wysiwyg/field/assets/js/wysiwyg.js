    ...
    this.init = function() {
        ...
        $('.draggable-file').draggable({
          ...
          stop: function(event, ui) {
              ...
              var main_coords = $('.mainbar').position();
              
              $('.wysiwyg-editor').each(function(){
                var coords = $(this).position();
                coords.bottom = coords.top + $(this).height();
                coords.bottomRight = coords.left + $(this).width();
                console.log(ui.position.top)
                console.log(coords.bottom)
                var $editor = $(this);
                  if(ui.position.top >= coords.top && ui.position.top <= coords.bottom && ui.position.left >= main_coords.left && ui.position.left <= main_coords.left + $(this).outerWidth()){
                      console.info("inside");
