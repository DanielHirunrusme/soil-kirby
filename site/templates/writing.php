    ...
    <div class="block">
      ...
      <div class="text">
        ...
        <div class="inner">
          ...
          <h1><?= $page->title()->smartypants() ?><?php if(!$page->location()->empty()): ?>, <?= $page->location() ?><?php endif; ?><?php if(!$page->publication()->empty()): ?>, <em><?= $page->publication() ?></em><?php endif; ?><?php if($page->date()!=null): ?>, <?= $page->date('F j, Y') ?><?php endif; ?></h1>
